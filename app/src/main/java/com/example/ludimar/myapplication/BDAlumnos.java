...
public class BDAlumnos extends SQLiteOpenHelper {
    ...
    String sqlCreate = "CREATE TABLE registro (id INTEGER PRIMARY KEY AUTOINCREMENT, " +
            "usuario TEXT, " +
            "clave TEXT," +
            " email TEXT, " +
            "pregunta TEXT, " +
    ...
    String sqlCreate2 = "CREATE TABLE registro (id INTEGER PRIMARY KEY AUTOINCREMENT, " +
                        "usuario TEXT, " +
                        "clave TEXT," +
                        " email TEXT, " +
                        "pregunta TEXT, " +
